 ...
 * Autoboxing: Go from a primitive data type to wrapper class.
 * Unboxing: Or a wrapper class to primitive data type with relative ease in Java.
 *
 * Autoboxing challenge --- banking case study (customer's transaction).
 */
